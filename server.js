...
app.use(session({ store: new FileStore({ path: './sessions', ttl: 86400 }), secret: process.env.SESSION_SECRET || 'netquery_secret_2024', resave: false, saveUninitialized: false, cookie: { maxAge: 86400000 } }));
